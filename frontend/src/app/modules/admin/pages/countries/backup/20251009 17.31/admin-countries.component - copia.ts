...
export class AdminCountriesComponent implements OnInit {
  ...
  tableColumns: TableColumn[] = [
    { key: 'toggle', label: '', sticky: 'left', width: '44px' }, // para el toggle/select con el ancho correcto
    ...
    // Puedes añadir aquí más columnas o iconos personalizados, flags, etc.
  ];
  totalCountries = 0;
  page = 1;
  pageSize = 10;
  ...
  eliminarPais(): void {
    this.countriesService.deleteCountry(this.countryForm.value.id).subscribe(() => {
