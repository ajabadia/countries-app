...
export abstract class BaseAdminComponent<T extends { id: string | number }> implements OnInit {
  ...
  // ✅ CORRECCIÓN: Aceptamos 'any' desde la plantilla para evitar errores de tipado,
  // ya que TableComponent no es genérico y su evento (edit) no está fuertemente tipado.
  // La lógica interna sigue siendo segura.
  onEdit(entity?: T | any): void {
