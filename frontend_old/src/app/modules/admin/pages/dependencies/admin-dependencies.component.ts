...
import { Dependency } from '@services/dependency.model';
...
export class AdminDependenciesComponent extends BaseAdminPageComponent<Dependency> {
  ...
  public override tableColumns: TableColumn<Dependency>[] = [
